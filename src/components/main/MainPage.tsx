      ...
      <div className="grid max-w-screen-xl px-10 2xl:px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-32 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <div className="flex gap-2">
            <button onClick={handleClickLiveButton} className="inline-flex items-center justify-center w-32 h-12 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-md hover:bg-gray-100">
              Create Live
            </button>
            <button onClick={handleClickLiveButton} className="inline-flex w-32 h-12 items-center justify-center text-base font-medium text-center text-white rounded-md bg-blue-600 hover:bg-blue-800">
              Join Live
              <svg
