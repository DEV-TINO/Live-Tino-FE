...
function MyPage() {
  ...
  return (
    <div className="grid grid-cols-[minmax(24px,_1fr)_minmax(100px,150px)_24px_minmax(400px,_3fr)_minmax(24px,_1fr)]">
      ...
      <form className="col-start-4 w-72 ml-auto mb-4">   
        ...
        <div className="relative">
          ...
          <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-blue-600 hover:bg-blue-800 focus:outline-none font-medium rounded-lg text-sm px-4 py-2">검색</button>
        </div>
      </form>
