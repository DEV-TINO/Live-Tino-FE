  ...
  return (
    <form className="flex flex-col gap-2">
      <div className="mb-2">
        ...
        <input type="text" id="name" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="이름을 입력해주세요" required />
      </div>
      <div className="mb-2">
        <label className="block px-0.5 mb-1 text-sm font-medium text-gray-900">아이디</label>
        <div className="flex gap-2">
          <input type="text" id="id" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="아이디를 입력해주세요" required />
      ...
      <div className="mb-2">
        ...
        <input type="password" id="password" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="비밀번호를 입력해주세요" required />
      </div>
      <div className="mb-2">
        <label className="block mb-1 text-sm px-0.5 font-medium text-gray-900">비밀번호 확인</label>
        <input type="password" id="repeatPassword" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="비밀번호를 입력해주세요" required />
      </div>
      <div className="mb-2">
        <label className="block mb-1 text-sm font-medium px-0.5 text-gray-900">휴대폰 인증</label>
        <div className="flex gap-2">
          <input type="tel" id="phoneNum" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-1" placeholder="010-XXXX-XXXX" required />
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          <input id="checkNum" className="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-1" placeholder="인증번호를 입력해주세요" required />
